      ...
      <main class="conversation-main">
        ...
        <section v-if="report" class="message assistant-message"><div class="assistant-avatar">AI</div><div class="message-body analysis-report">
          ...
          <section v-if="report.autonomous_run" class="autonomous-run">
            ...
            <div class="reflection-item" v-for="item in report.autonomous_run.reflections" :key="item.iteration"><strong>第 {{ item.iteration }} 轮 · {{ item.decision }}</strong><p>{{ item.reason }}</p><small>下一步：{{ item.next_change }}</small></div>
