<template>
  <section class="page-surface execution-page">
    <div class="page-heading">
      ...
      <el-tag type="warning" effect="plain">Sandbox</el-tag>
    </div>
...
const eventTypeLabel=(value:string)=>({task_planned:"任务规划",context_loaded:"读取数据",policy_validated:"策略校验",change_prepared:"准备变更",campaign_prepared:"生成活动",approval_required:"审批断点",approved:"恢复执行",task_completed:"工具回执",task_rolled_back:"回滚完成"} as any)[value]||value
