...
export const ecommerceAPI = {
  ...
  teamMemories: () => client.get("/ecommerce/team/memories"),
  updateTeamMemory: (agent: string, key: string, value: Record<string, any>) => client.put(`/ecommerce/team/memories/${agent}/${key}`, { value }),
  automations: () => client.get("/ecommerce/automations"),
  toggleAutomation: (id: string, enabled: boolean) => client.put(`/ecommerce/automations/${id}`, { enabled }),
  runAutomation: (id: string) => client.post(`/ecommerce/automations/${id}/run`),
